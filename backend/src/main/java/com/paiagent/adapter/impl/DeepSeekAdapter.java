...
/**
 * DeepSeek adapter - OpenAI compatible API format.
 */
public class DeepSeekAdapter implements LLMAdapter {
    ...
    public DeepSeekAdapter(String apiKey, String baseUrl) {
        this.apiKey = apiKey;
        this.baseUrl = baseUrl.isEmpty() ? "https://api.deepseek.com/v1" : baseUrl;
    ...
    public String chat(String prompt, Map<String, Object> config) throws Exception {
        String model = (String) config.getOrDefault("model", "deepseek-chat");
