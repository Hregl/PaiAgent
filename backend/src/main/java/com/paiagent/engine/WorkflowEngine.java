...
public class WorkflowEngine {
    ...
    public WorkflowEngine(NodeExecutorFactory executorFactory, ObjectMapper objectMapper) {
    ...
    public Map<String, Object> execute(String definitionJson, String userInput) throws Exception {
        ...
        for (String nodeId : executionOrder) {
            ...
            // Inject user input for input nodes
        ...
        // Find output node and extract result
        for (String nodeId : executionOrder) {
            Map<String, Object> node = nodeMap.get(nodeId);
